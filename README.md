# Firebird SQL Server for ARM64 Docker
This Dockerfile is entirely based on the work of @jacobalberty and his [firebird-docker](https://github.com/jacobalberty/firebird-docker) repository. 
